		...
		*/
		...
		private static void MenuItem_NewProject_CreateUpmVersionManagerSetting()
		{
			string[] t_text_list = new string[]{
				...
				"					t_param.asmdef_runtime.reference_list[ii].url = t_param.asmdef_runtime.reference_list[ii].url.Replace(\"<<package_name>>\",t_param.asmdef_runtime.reference_list[ii].name);",
				"				}",
				"				for(int ii=0;ii<t_param.asmdef_editor.reference_list.Length;ii++){",
				"					t_param.asmdef_editor.reference_list[ii].url = t_param.asmdef_editor.reference_list[ii].url.Replace(\"<<package_name>>\",t_param.asmdef_editor.reference_list[ii].name);",
				"				}",
				"				for(int ii=0;ii<t_param.asmdef_sample.reference_list.Length;ii++){",
				"					t_param.asmdef_sample.reference_list[ii].url = t_param.asmdef_sample.reference_list[ii].url.Replace(\"<<package_name>>\",t_param.asmdef_sample.reference_list[ii].name);",
				"				}",
				"",
				"				//changelog",
